...
import { AgentResult, Issue, User, Notification, Prediction } from '@/types';
...
interface AppState {
  ...
  processingResults: AgentResult[];
  setProcessing: (isProcessing: boolean) => void;
  setProcessingStep: (step: string) => void;
  addProcessingResult: (result: AgentResult) => void;
  ...
  setMapFilter: (filter: 'all' | 'critical' | 'high' | 'medium' | 'low' | 'resolved' | 'predicted') => void;
