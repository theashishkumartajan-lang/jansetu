import { Issue, User, Prediction, Escalation, LeaderboardEntry, Notification, VerificationResult } from '@/types';
...
export const MOCK_USERS: User[] = [
  { id: 'u1', name: 'Amit Sharma', email: 'amit@example.com', trustScore: 94, points: 2450, streak: 12, badges: ['Civic Hero', 'Road Guardian', 'Community Champion', 'Verification Pro', 'Civic Streak Master'], role: 'citizen', avatar: 'https://i.pravatar.cc/150?u=u1', area: 'Andheri West', reportsCount: 48, verifiedCount: 32, joinedAt: new Date('2024-01-15') },
  { id: 'u2', name: 'Priya Patel', email: 'priya@example.com', trustScore: 88, points: 1890, streak: 8, badges: ['Water Warrior', 'Smart Reporter', 'Clean Street Captain', 'Local Mapper'], role: 'citizen', avatar: 'https://i.pravatar.cc/150?u=u2', area: 'Bandra East', reportsCount: 35, verifiedCount: 22, joinedAt: new Date('2024-02-10') },
  { id: 'u3', name: 'Rahul Kumar', email: 'rahul@example.com', trustScore: 76, points: 1200, streak: 4, badges: ['First Responder', 'Night Safety Watch'], role: 'citizen', avatar: 'https://i.pravatar.cc/150?u=u3', area: 'Dadar', reportsCount: 24, verifiedCount: 15, joinedAt: new Date('2024-03-05') },
...
export const MOCK_NOTIFICATIONS: Notification[] = [
  { id: 'n1', userId: 'u1', title: 'Issue Verified!', message: 'Your pothole report (ISS-001) has been verified and assigned to Public Works.', type: 'success', read: false, createdAt: new Date('2024-06-21'), actionUrl: '/citizen' },
  { id: 'n2', userId: 'u1', title: 'Civic Score Earned!', message: 'You earned 25 Civic Score for a verified issue. Your streak is now 12 days!', type: 'reward', read: false, createdAt: new Date('2024-06-21'), actionUrl: '/community' },
...
export const BADGE_INFO: Record<string, { icon: string; description: string; requirement: string; color: string }> = {
  ...
  'Smart Reporter': { icon: 'Brain', description: 'First smart report submitted', requirement: 'Submit 1 analyzed report', color: 'from-purple-500 to-violet-600' },
  ...
  'Clean Street Captain': { icon: 'Award', description: 'Keeps public areas clean', requirement: '5 garbage reports verified', color: 'from-emerald-500 to-green-600' },
  'Night Safety Watch': { icon: 'Star', description: 'Improves safety after dark', requirement: '3 streetlight or hazard reports', color: 'from-slate-700 to-blue-900' },
  'Drain Defender': { icon: 'Droplets', description: 'Prevents flooding and stagnation', requirement: '5 drainage reports verified', color: 'from-sky-500 to-cyan-700' },
  'Tree Protector': { icon: 'Shield', description: 'Protects public green cover', requirement: '3 tree or park reports verified', color: 'from-lime-500 to-emerald-700' },
  'Escalation Expert': { icon: 'AlertTriangle', description: 'Tracks delayed critical issues', requirement: 'Help escalate 3 overdue reports', color: 'from-orange-500 to-red-600' },
  'Verification Pro': { icon: 'CheckCircle', description: 'Confirms completed civic repairs', requirement: 'Verify 10 resolved reports', color: 'from-teal-500 to-emerald-600' },
  'Local Mapper': { icon: 'MapPin', description: 'Adds accurate ward locations', requirement: 'Submit 15 GPS-verified reports', color: 'from-indigo-500 to-blue-600' },
  'Civic Streak Master': { icon: 'Clock', description: 'Maintains consistent civic action', requirement: 'Maintain a 10-day activity streak', color: 'from-pink-500 to-rose-600' },
};
