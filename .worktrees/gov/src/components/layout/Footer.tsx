...
import { Zap, Globe, X, Mail } from "lucide-react";
        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-4">
          ...
          <div>
            ...
            <div className="mt-4 flex gap-4">
              <a href="#" className="text-slate-400 hover:text-[#00D4AA]"><Globe className="h-5 w-5" /></a>
              <a href="#" className="text-slate-400 hover:text-[#00D4AA]"><X className="h-5 w-5" /></a>
              <a href="#" className="text-slate-400 hover:text-[#00D4AA]"><Mail className="h-5 w-5" /></a>
            </div>
          </div>
        </div>
